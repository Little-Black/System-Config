...
" Disable replace mode (tired of it)
...
" For git rebase interactive (fixup the commit on a current line)
:nnoremap f :s/pick/f/<CR>
:nnoremap r :s/pick/r/<CR>
:nnoremap e :s/pick/e/<CR>
